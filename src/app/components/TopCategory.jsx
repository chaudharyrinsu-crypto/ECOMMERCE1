    ...
    return (
        <>
            <section className='px-3 py-5 w-full md:block hidden'>
                <div className='grid grid-cols-4 gap-2.5 max-h-110 w-full'>
                    <div className='h-full w-full rounded-2xl overflow-hidden relative group hover:rounded-[200px] transition-all duration-500'>
                        ...
                        <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white  text-center flex flex-col gap-2 items-center justify-center group-hover:-translate-y-[60%] transition-all duration-600 '>
                            <p className='inline-block px-4 whitespace-nowrap lg:px-5 text-center py-1 rounded-4xl border'>New Arrivals</p>
                            <div className='hidden group-hover:block opacity-0 group-hover:opacity-100 space-y-2.5  transition-all duration-800'>
                                <Link className='hidden group-hover:block opacity-0 group-hover:opacity-100 px-5 text-center py-1 rounded-4xl border transition-all duration-500' href='/collection/mens-new-arrivals'>Shop Men</Link>
                                <Link href='/collection/womens-new-arrivals' className=' hidden group-hover:block opacity-0 group-hover:opacity-100 px-5 text-center py-1 rounded-4xl border transition-all duration-600'>Shop Women</Link>
                            </div>
                        </div>
                    </div>
                    <div className='h-full w-full rounded-2xl overflow-hidden relative group hover:rounded-[200px] transition-all duration-500'>
                        ...
                        <div className='absolute  top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white  text-center flex flex-col gap-2 items-center justify-center group-hover:-translate-y-[60%] transition-all duration-600 '>
                            <p className='inline-block px-4 lg:px-5 text-center py-1 rounded-4xl border'>Mens</p>
                            <div className='hidden group-hover:block opacity-0 group-hover:opacity-100 space-y-2.5  transition-all duration-800'>
                                <Link className='inline-blockhidden group-hover:block opacity-0 group-hover:opacity-100 px-5 text-center py-1 rounded-4xl border  duration-500' href='/collection/mens'>Shop Men</Link>
                            </div>
                        </div>
                    </div>
                    <div className='h-full w-full rounded-2xl overflow-hidden relative group hover:rounded-[200px] transition-all duration-500'>
                        ...
                        <div className='absolute  top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white  text-center flex flex-col gap-2 items-center justify-center group-hover:-translate-y-[60%] transition-all duration-600 '>
                            <p className='inline-block px-4 lg:px-5 text-center py-1 rounded-4xl border'>Womens</p>
                            <div className='hidden group-hover:block opacity-0 group-hover:opacity-100 space-y-2.5  transition-all duration-800'>
                    ...
                    <div className='h-full w-full rounded-2xl overflow-hidden relative group hover:rounded-[200px] transition-all duration-500'>
                        ...
                        <div className='absolute  top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white  text-center flex flex-col gap-2 items-center justify-center group-hover:-translate-y-[60%] transition-all duration-600 '>
                            <p className='inline-block px-4 lg:px-5 text-center py-1 rounded-4xl border'>Bestsellers</p>
                            <div className='hidden group-hover:block opacity-0 group-hover:opacity-100 space-y-2.5  transition-all duration-800'>
