...
import { newArrivashoeItem } from '../data/Alldata'
                            ...
                            <Link href='/' className=' '>
                                ...
                                <div className='px-5 space-y-2'>
                                    ...
                                    <div className='flex justify-between items-center pt-2 pl-1'>
                                        <span style={{ backgroundColor: item.colorcode }} className={`h-5 w-5 rounded-full border  border-black outline outline-offset-3`}></span>
