...
const TopCategoryMobRes = () => {
    return (
        <>
            <section className="w-full pt-20 md:hidden block">
                <Swiper
                    // modules={[Navigation]}
                    spaceBetween={10}
                    breakpoints={{
                ...
                >
                    <SwiperSlide className=''>
                        <div className='w-full h-[440px] rounded-3xl hover:rounded-[200px] overflow-hidden relative group transition-all duration-500'>
                            ...
                            <div className='absolute  top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white  text-center flex flex-col gap-2 items-center justify-center group-hover:-translate-y-[60%] transition-all duration-600 '>
                                <Link href={`/collection/mens-new-arrivals`} className='inline-block px-3 text-center py-1 rounded-4xl border'>New Arrivals</Link>
                    ...
                    <SwiperSlide>
                        <div className='w-full h-[440px] rounded-xl hover:rounded-[200px] overflow-hidden relative group transition-all duration-500'>
                            ...
                            <div className='absolute  top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white  text-center flex flex-col gap-2 items-center justify-center group-hover:-translate-y-[60%] transition-all duration-600 '>
                                <Link href={`/collection/mens`} className='inline-block px-3 text-center py-1 rounded-4xl border'>Mens</Link>
                                {/* hidden group-hover:block */}
                                <div className='hidden group-hover:block opacity-0 group-hover:opacity-100 space-y-2.5 transition-all duration-500'>
                                    <Link className='hidden group-hover:block opacity-0 group-hover:opacity-100 px-3 text-center py-1 rounded-4xl border  duration-500' href='/collection/mens'>Shop Men</Link>
                                </div>
                            </div>
                        </div>
                    </SwiperSlide>
                    <SwiperSlide>
                        <div className='w-full h-[440px] rounded-3xl hover:rounded-[200px] overflow-hidden relative group transition-all duration-500'>
                            ...
                            <div className='absolute  top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white  text-center flex flex-col gap-2 items-center justify-center group-hover:-translate-y-[60%] transition-all duration-600 '>
                                <Link href={`/collection/womens`} className='inline-block px-5 text-center py-1 rounded-4xl border'>Womens</Link>
                                <div className='hidden group-hover:block opacity-0 group-hover:opacity-100 space-y-2.5 transition-all duration-500'>
                    ...
                    <SwiperSlide>
                        <div className='w-full h-[440px] rounded-3xl hover:rounded-[200px] overflow-hidden relative group transition-all duration-500'>
                            ...
                            <div className='absolute  top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white  text-center flex flex-col gap-2 items-center justify-center group-hover:-translate-y-[60%] transition-all duration-600 '>
                                <Link href={`/collection/bestsellers/mens`} className='inline-block px-3 text-center py-1 rounded-4xl border'>Bestsellers</Link>
                                {/* hidden group-hover:block */}
                                <div className='hidden group-hover:block opacity-0 group-hover:opacity-100 space-y-2.5 transition-all duration-500'>
