  ...
  return (
    <>
      <section className='px-3'>
        <div>
            <img src="https://www.allbirds.com/cdn/shop/files/26Q1_Terralux_Site_ProductGrid_Desktop-Mobile_9x16_M_v2_57cea5bb-913d-4995-bfb3-f2b866972fb6.jpg?v=1771541746&width=1280" alt="menshoe" />
            <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2.5 max-w-6xl mx-auto px-4 py-3.5 tracking-wider'>
                {products
                    .filter(i => i.gender === 'men').slice(1,4)
                    .map((item, index) => (
