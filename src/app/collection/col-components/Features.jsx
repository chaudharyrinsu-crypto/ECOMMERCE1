...
const Features = () => {
    ...
    return (
        <>
            <div className='px-3 '>
                <h2 className='lg:text-4xl md:text-3xl text-2xl py-15 text-center'>Better Materials, Done Right.</h2>
                <div className='relative h-150'>
                    ...
                    {/* <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white w-[70%]'>
                        <div className='grid grid-cols-3 gap-15 items-center justify-between text-sm'>
                            <div className='flex flex-col md:gap-10 gap-5 lg:gap-20 text-right tracking-wide'>
                                <div>
                            ...
                            <div className='flex items-center justify-center relative'>
                                <div className='relative flex items-center justify-center'>
                                    <div className='relative border border-[#575757] sm:h-87.5 sm:w-87.5 h-80 w-80 rounded-full flex items-center justify-center'>
                                        <span className='absolute top-1/2 left-0 -translate-y-1/2 h-1.5 w-1.5 rounded-full bg-white'></span>
                                        <span className='absolute top-1/2 right-0 -translate-y-1/2 h-1.5 w-1.5 rounded-full bg-white'></span>
                                    </div>
                                    <div className='border border-[#ECE9E2] sm:h-75 h-70 w-70 sm:w-75 rounded-full absolute'></div>
                                </div>
                            </div>
