...
const Nav = () => {
    return (
        <>
            <nav className='bg-transparent lg:bg-[#E0DACF] gap-2 flex items-center w-full sm:max-w-6xl mx-auto rounded-full px-2 sm:px-4 py-0 lg:py-3 text-sm'>
                <ul className='flex lg:gap-2 lg:justify-start justify-between items-center lg:border-none border rounded-full py-1 px-2 flex-1'>
                    ...
                    <li className='block lg:hidden items-center text-[#212121]  p-1  '>
                        <Link className='p-[1px] flex items-center justify-center rounded-full border border-[#212121]' href='/'><RiArrowDownSLine /></Link>
                    </li>
                </ul>
