...
const BigImg = () => {
    return (
        <>
            <section className='px-8 pb-30 lg:block hidden'>
                <div className='relative text-white'>
                    <img className='rounded-3xl object-cover w-full h-full' src="https://www.allbirds.com/cdn/shop/files/25Q2_BAU_Site_Moonshot_BrandMessage_Lifestyle_Desktop_16x9_withVeil_4e2589c0-b881-4155-a7c9-b1617e4b9333.jpg?v=1758318144&width=1920" alt="bigimg" />
                    <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 border border-white p-5 rounded-full'>
                        <div className='border border-white p-5 rounded-full'>
                            <div className='text-center space-y-4 border border-white md:p-20 p-10 lg:p-25 rounded-full'>
