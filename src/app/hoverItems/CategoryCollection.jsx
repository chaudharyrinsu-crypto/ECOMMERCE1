            ...
            <section className='absolute top-0 left-0 z-50 bg-[#ECE9E2] w-full py-20'>
                <div className='max-w-330 m-auto'>
                    ...
                    <Link className='uppercase flex mt-6 font-medium hover:underline' key={a} href='/'>{a}</Link>
                            ...
                            <Link className=' flex mt-6 font-medium hover:underline' href='/collection/mens-new-arrivals'>New Arrivals</Link>
                            <Link className=' flex mt-6 font-medium hover:underline' href='/collection/bestsellers/mens'>Bestsellers</Link>
